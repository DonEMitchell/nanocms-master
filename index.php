...
<html>
	<head>
		<title> <?php show_content_area('WebSite Name'); ?> - <?php show_title(); ?></title>
			...
			<div class="container">
				<div class="row">
					<div class="12u">
						...
						<header id="header">
							<h1><a href="index.php" id="logo"><?php show_content_area('WebSite Name'); ?></a></h1>
<h4>
								...
								<div class="row">
									<div class="6u">
										<ul class="link-list">
											...
											<li><a href="#">
<?php show_links('links'); ?>
</a></li>
<br />
<hr>
	<h1> <?php show_content_area('Below Navigation'); ?></h1>									</ul>
									</div>
																	</div>
							</div>
						</section>
