...
Event.register(window,"load",function() {
	// add the rel="lightbox" attribute to every image-link
	prepZooms();
	
	var lightbox = new LightBox({
		loadingimg:'secret/tweaks/lightbox_plus/loading.gif',
		expandimg:'secret/tweaks/lightbox_plus/expand.gif',
		shrinkimg:'secret/tweaks/lightbox_plus/shrink.gif',
		previmg:'secret/tweaks/lightbox_plus/prev.gif',
		nextimg:'secret/tweaks/lightbox_plus/next.gif',
		effectimg:'secret/tweaks/lightbox_plus/zzoop.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'effectable',
		closeimg:'secret/tweaks/lightbox_plus/close.gif',
		resizable:true
	});
});